...
export const caseStudy = {
  ...
  summary: [
    ...
    'The result: a professional web presence that positions BlueTide as a leading provider of marine and subsea solutions in the maritime industry, driving qualified inquiries and business growth.',
  ],
  logo,
  image: { src: imageHero },
  date: '2024-05',
...
- Position them as a leading maritime services provider in their regional markets
