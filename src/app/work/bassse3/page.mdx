...
export const caseStudy = {
  client: 'Bassse3',
  title: 'Bassse3: Next-gen Brand Experience',
  description:
  ...
  testimonial: {
    ...
    content:
      'Working with NexProve, we felt more like a partner than a customer. They really resonated with our mission to change the way people convince their parents to cash out their pensions.',
  },
}
...
>
  Working with NexProve, we felt more like a partner than a customer. They really
