...
export const socialMediaProfiles = [
  { title: 'Facebook', href: 'https://facebook.com/nexprove', icon: FacebookIcon },
  { title: 'Instagram', href: 'https://instagram.com/nexprove', icon: InstagramIcon },
  { title: 'GitHub', href: 'https://github.com/nexprove', icon: GitHubIcon },
  { title: 'Dribbble', href: 'https://dribbble.com/nexprove', icon: DribbbleIcon },
]
